...
--DROP TABLE IF EXISTS "aims"."OrderItem";
...
--DROP TABLE IF EXISTS "aims"."Product";
...
--            REFERENCES "Order" ("id")
--);
--CREATE INDEX "aims"."OrderItem.fk_orderproduct_order_idx" ON "OrderItem" ("orderID");
